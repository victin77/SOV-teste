...
app.post('/api/leads', auth_1.authMiddleware, wrapAsync(async (req, res) => {
...
app.put('/api/leads/:id', auth_1.authMiddleware, wrapAsync(async (req, res) => {
...
app.delete('/api/leads/:id', auth_1.authMiddleware, wrapAsync(async (req, res) => {
    const id = req.params.id;
    const existing = await store.getLead(id);
    if (!existing)
        return res.status(404).json({ error: 'not_found' });
...
app.post('/api/leads/replace', auth_1.authMiddleware, wrapAsync(async (req, res) => {
...
app.get('/api/audit', auth_1.authMiddleware, wrapAsync(async (req, res) => {
